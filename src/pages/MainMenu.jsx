        ...
        <div className="font-poppins bg-gray-100 min-h-screen flex justify-center items-center py-12">
            <div>
                ...
                <div className="flex flex-col items-center">
                    <a href="https://api.whatsapp.com/send/?phone=573172309528&text&type=phone_number&app_absent=0" className="animate-bounce flex mt-10 bg-green-600 py-3 px-16 rounded-xl relative drop-shadow-lg">
                    ...
                    <div className="flex flex-col items-center justify-center mt-20">
                        ...
                        <a href="mailto:contacto@brandadvisories.com?subject=Tengo Interés en sus Servicios" className=" animate-pulse mt-2">
