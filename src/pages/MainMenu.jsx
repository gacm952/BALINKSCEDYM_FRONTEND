const MainMenu = () => {
  return (
    <>
        <div className="font-poppins bg-gray-100 min-h-screen flex justify-center items-center py-12">
            <div>
                <div className="flex justify-center drop-shadow mb-16">
                ...
                <div className="flex justify-center text-center">
                    <p className="text-green-600 text-[13.5px] font-normal">¡Comience su viaje hacia una vida saludable <span className="text-green-600 text-sm font-bold">HOY</span>!</p>
                </div>
                <div className="flex flex-col items-center">
                    <a href="https://api.whatsapp.com/send/?phone=573172309528&text=Hola%20CEDYM,%20¡Quiero%20Agendar%20una%20Cita!." className="animate-bounce flex mt-10 bg-green-600 py-3 px-16 rounded-xl relative drop-shadow-lg">
                        <svg className="animate-pulse absolute left-4 bottom-2.5" width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        ...
                        <a href="https://www.facebook.com/cedymco" target="_blank" className="mb-6 justify-center flex items-center rounded-full drop-shadow-md bg-gray-200 py-[5px] px-[84px] relative">
                            ...
                            <p className="text-green-600 text-[13px] font-medium">Facebook</p> 
                        </a>
                        <a href="https://www.tiktok.com/@cedymco" target="_blank" className="justify-center flex items-center rounded-full drop-shadow-md bg-gray-200 py-[5px] px-[84px] relative">
                            <svg className="absolute left-4" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="tiktok-square-icon 1" clip-path="url(#clip0_10_31)">
                                <path id="Vector" fill-rule="evenodd" clip-rule="evenodd" d="M19.0342 0H1.9721C0.888389 0 0 0.846085 0 1.87219V18.1218C0 19.1539 0.888389 19.994 1.9721 19.994H19.0342C20.1179 19.994 21.0063 19.1479 21.0063 18.1218V1.87219C21.0063 0.840084 20.1179 0 19.0342 0ZM13.0738 3.73837C13.2943 5.51455 14.3339 6.57666 16.1422 6.69067V8.68887C15.09 8.78488 14.1701 8.46085 13.099 7.84278V11.5812C13.099 16.3336 7.66157 17.8218 5.47525 14.4134C4.07021 12.2232 4.92709 8.37684 9.43834 8.22082V10.333C9.09811 10.387 8.72637 10.471 8.39244 10.5731C7.39064 10.8971 6.82358 11.5032 6.9811 12.5653C7.28353 14.6115 11.2277 15.2115 10.8938 11.2151V3.73237H13.0675L13.0738 3.73837Z" fill="#16A34A"/>
                                </g>
                                <defs>
                            ...
                            <p className="text-green-600 text-[13px] font-medium">TikTok</p> 
                        </a>
                    </div>
                    <div className="flex flex-col items-center justify-center mt-20">
                        <p className="text-[10px] text-green-600">Desarrollado por</p>
                        <a href="mailto:contacto@brandadvisories.com?subject=Tengo Interés en sus Servicios" className="mt-2">
